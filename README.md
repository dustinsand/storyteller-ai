...
NOTE: The image creation step in GPTScript is not working yet, it is failing with a permission error.

## Getting Started

First, create an env.local file and add the OPENAI_API_KEY.
